...
class TurtleClient(Node):
    def __init__(self):
        ...
        ### parameter init for turtleColor and penSize###
        self.declare_parameter('turtleColor', 'red', ParameterDescriptor(description='default color of turtle'))
        self.declare_parameter('penSize', 2, ParameterDescriptor(description='default size of pen'))
        
        ### read param values and change turtle display color ###
