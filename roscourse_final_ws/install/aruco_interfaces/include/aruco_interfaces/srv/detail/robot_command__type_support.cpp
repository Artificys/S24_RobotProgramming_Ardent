...
{
  new (message_memory) aruco_interfaces::srv::RobotCommand_Request(_init);
}

void RobotCommand_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<aruco_interfaces::srv::RobotCommand_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotCommand_Request_message_member_array[1] = {
  {
    ...
    offsetof(aruco_interfaces::srv::RobotCommand_Request, target_pose),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotCommand_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(aruco_interfaces::srv::RobotCommand_Request),
...
{
  return &::aruco_interfaces::srv::rosidl_typesupport_introspection_cpp::RobotCommand_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aruco_interfaces, srv, RobotCommand_Request)() {
  return &::aruco_interfaces::srv::rosidl_typesupport_introspection_cpp::RobotCommand_Request_message_type_support_handle;
}
...
void RobotCommand_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) aruco_interfaces::srv::RobotCommand_Response(_init);
}

void RobotCommand_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<aruco_interfaces::srv::RobotCommand_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotCommand_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aruco_interfaces::srv::RobotCommand_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotCommand_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(aruco_interfaces::srv::RobotCommand_Response),
...
{
  return &::aruco_interfaces::srv::rosidl_typesupport_introspection_cpp::RobotCommand_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aruco_interfaces, srv, RobotCommand_Response)() {
  return &::aruco_interfaces::srv::rosidl_typesupport_introspection_cpp::RobotCommand_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers RobotCommand_service_members = {
  ...
  // see get_service_type_support_handle<aruco_interfaces::srv::RobotCommand>()
...
get_service_type_support_handle<aruco_interfaces::srv::RobotCommand>()
{
  ...
  auto service_type_support =
    &::aruco_interfaces::srv::rosidl_typesupport_introspection_cpp::RobotCommand_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aruco_interfaces, srv, RobotCommand)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<aruco_interfaces::srv::RobotCommand>();
}
