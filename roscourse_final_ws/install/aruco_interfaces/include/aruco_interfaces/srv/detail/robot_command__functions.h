...
#ifndef ARUCO_INTERFACES__SRV__DETAIL__ROBOT_COMMAND__FUNCTIONS_H_
#define ARUCO_INTERFACES__SRV__DETAIL__ROBOT_COMMAND__FUNCTIONS_H_
 ...
 * calls
 * aruco_interfaces__srv__RobotCommand_Request__init().
...
/**
 * It calls
 * aruco_interfaces__srv__RobotCommand_Request__fini()
 ...
 * aruco_interfaces__srv__RobotCommand_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * aruco_interfaces__srv__RobotCommand_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * aruco_interfaces__srv__RobotCommand_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_aruco_interfaces
...
/**
 * It calls
 * aruco_interfaces__srv__RobotCommand_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_aruco_interfaces
...
/**
 * It allocates the memory for the array and calls
 * aruco_interfaces__srv__RobotCommand_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_aruco_interfaces
...
/**
 * It calls
 * aruco_interfaces__srv__RobotCommand_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ARUCO_INTERFACES__SRV__DETAIL__ROBOT_COMMAND__FUNCTIONS_H_
